...
class DepartamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create departamento" do
    assert_difference("Departamento.count") do
      post departamentos_url, params: { departamento: { baños: @departamento.baños, edificio_id: @departamento.edificio_id, estado: @departamento.estado, habitaciones: @departamento.habitaciones, modalidad: @departamento.modalidad, numero: @departamento.numero, precio: @departamento.precio } }
    end
  ...
  test "should update departamento" do
    patch departamento_url(@departamento), params: { departamento: { baños: @departamento.baños, edificio_id: @departamento.edificio_id, estado: @departamento.estado, habitaciones: @departamento.habitaciones, modalidad: @departamento.modalidad, numero: @departamento.numero, precio: @departamento.precio } }
